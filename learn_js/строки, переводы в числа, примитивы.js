...
console.log(parseInt('42px42')); // 42 - идет до первой ошибки, но при этом не выдает ошибку NaN
...
// toPrimitive - ФУНКЦИЯ, КОТОРУЮ ПРОБУЕТ ВЫЗВАТЬ ДВИЖОК, ЕСЛИ НЕ ЗНАЕТ КАК ПРЕОБРАЗОВЫВАТЬ ТИПЫ
...
// 
null == undefined // при таком сравнении будет тру!
+0 === -0 // false
Object.is(NaN, NaN) // единственный стабильный способ проверить NaN, т.к. NaN не равен самому себе, а функция isNaN('string') - выдавт тру, из-за преобраз-я число..
Symbol //  можно преобразовывать только явно
