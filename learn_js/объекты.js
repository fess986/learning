...
// запрет изменения объекта пользователем
const obj = {};
Object.preventExtensions(obj);  // запрет. попытка записи вызовет ошибку в стрикте
...
let clone = {...myDog}; // полный эквивалент предыдущей строки
